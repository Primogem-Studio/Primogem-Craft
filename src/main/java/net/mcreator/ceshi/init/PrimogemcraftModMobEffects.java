...
import net.mcreator.ceshi.potion.XxufsMobEffect;
...
import net.mcreator.ceshi.potion.JqyydmMobEffect;
import net.mcreator.ceshi.potion.JishengMobEffect;
import net.mcreator.ceshi.potion.JinguMobEffect;
...
import net.mcreator.ceshi.potion.HpyxgMobEffect;
...
import net.mcreator.ceshi.potion.CxbdMobEffect;
...
import net.mcreator.ceshi.potion.BnxxuMobEffect;
