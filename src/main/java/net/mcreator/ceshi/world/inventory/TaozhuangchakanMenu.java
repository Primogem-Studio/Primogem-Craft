...
public class TaozhuangchakanMenu extends AbstractContainerMenu implements PrimogemcraftModMenus.MenuAccessor {
	...
	public TaozhuangchakanMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(PrimogemcraftModMenus.TAOZHUANGCHAKAN.get(), id);
	...
	public static void onPlayerTick(PlayerTickEvent.Post event) {
		...
		if (entity.containerMenu instanceof TaozhuangchakanMenu menu) {
