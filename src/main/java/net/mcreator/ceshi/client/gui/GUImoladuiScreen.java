...
public class GUImoladuiScreen extends AbstractContainerScreen<GUImoladuiMenu> implements PrimogemcraftModScreens.ScreenAccessor {
	private final Level world;
	private final int x, y, z;
	private final Player entity;
	private boolean menuStateUpdateActive = false;

	public GUImoladuiScreen(GUImoladuiMenu container, Inventory inventory, Component text) {
