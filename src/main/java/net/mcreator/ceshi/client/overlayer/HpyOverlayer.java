...
class HpyOverlayer implements LayeredDraw.Layer {
    private static final Component[] com = {Component.literal("◆"), Component.literal("◆◆"), Component.literal("◆◆◆"), Component.literal("◆◆◆◆"), Component.literal("◆◆◆◆◆"), Component.literal("◆◆◆◆◆◆"), Component.literal("◆×∞")};
    ...
    public void render(GuiGraphics graphics, DeltaTracker deltaTracker) {
        ...
        if (count < 1) return;
        var text = count > 6 ? com[6] : com[count - 1];
