...
import net.mcreator.ceshi.procedures.Szbf_ct_msProcedure;
...
public class SzcItem extends HoeItem {
	...
	public SzcItem() {
		super(TOOL_TIER, new Item.Properties().attributes(DiggerItem.createAttributes(TOOL_TIER, 2f, -3f)).fireResistant());
	}
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		String hoverText = Szbf_ct_msProcedure.execute(entity, itemstack);
		if (hoverText != null) {
