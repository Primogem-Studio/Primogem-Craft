...
public class SztjItem extends SwordItem {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.primogemcraft.sztj.description_0"));
		list.add(Component.translatable("item.primogemcraft.sztj.description_1"));
		list.add(Component.translatable("item.primogemcraft.sztj.description_2"));
		list.add(Component.translatable("item.primogemcraft.sztj.description_3"));
	}
}