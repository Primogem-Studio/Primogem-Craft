...
public class ZizaitiejianItem extends SwordItem {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.primogemcraft.zizaitiejian.description_0"));
		list.add(Component.translatable("item.primogemcraft.zizaitiejian.description_1"));
		list.add(Component.translatable("item.primogemcraft.zizaitiejian.description_2"));
	}
}