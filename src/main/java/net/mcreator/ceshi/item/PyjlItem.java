...
import net.mcreator.ceshi.procedures.PyjlsxProcedure;
import net.mcreator.ceshi.procedures.Pyjlsx0Procedure;
import net.mcreator.ceshi.procedures.PyjlmsProcedure;
import net.mcreator.ceshi.procedures.JlqhewaiProcedure;
import net.mcreator.ceshi.init.PrimogemcraftModItems;

import java.util.List;

public class PyjlItem extends SwordItem {
	...
	public boolean hurtEnemy(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
		...
		Pyjlsx0Procedure.execute(entity.level(), entity, sourceentity, itemstack);
		return retval;
	}
