...
import net.mcreator.ceshi.procedures.Szbf_g_msProcedure;
...
public class SzgItem extends PickaxeItem {
	...
	public boolean mineBlock(ItemStack itemstack, Level world, BlockState blockstate, BlockPos pos, LivingEntity entity) {
		...
		SzgsxProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ(), entity, itemstack);
		return retval;
	}
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		String hoverText = Szbf_g_msProcedure.execute(entity, itemstack);
		if (hoverText != null) {
