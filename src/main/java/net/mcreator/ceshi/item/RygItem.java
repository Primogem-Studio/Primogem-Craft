...
import net.mcreator.ceshi.procedures.Rymn_g_msProcedure;
...
public class RygItem extends PickaxeItem {
	...
	public boolean mineBlock(ItemStack itemstack, Level world, BlockState blockstate, BlockPos pos, LivingEntity entity) {
		...
		RygsxProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ(), blockstate, entity, itemstack);
		return retval;
	}
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		String hoverText = Rymn_g_msProcedure.execute(entity, itemstack);
		if (hoverText != null) {
