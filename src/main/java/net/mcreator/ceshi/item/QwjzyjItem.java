...
public class QwjzyjItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.primogemcraft.qwjzyj.description_0"));
		list.add(Component.translatable("item.primogemcraft.qwjzyj.description_1"));
		list.add(Component.translatable("item.primogemcraft.qwjzyj.description_2"));
