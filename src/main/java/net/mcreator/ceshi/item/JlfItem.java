...
import net.mcreator.ceshi.procedures.Jlhy_f_msProcedure;
...
public class JlfItem extends AxeItem {
	...
	public boolean mineBlock(ItemStack itemstack, Level world, BlockState blockstate, BlockPos pos, LivingEntity entity) {
		...
		JlfsxProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ(), entity, itemstack);
		return retval;
	}
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		String hoverText = Jlhy_f_msProcedure.execute(entity, itemstack);
		if (hoverText != null) {
