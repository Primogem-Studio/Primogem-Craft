...
public class JlfItem extends AxeItem {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.primogemcraft.jlf.description_0"));
		list.add(Component.translatable("item.primogemcraft.jlf.description_1"));
		list.add(Component.translatable("item.primogemcraft.jlf.description_2"));
	}
}