	...
	public static String execute(Entity entity, ItemStack itemstack) {
		...
		return MSHSwuqi00Procedure.execute(entity, itemstack,
				"\u00A76\u00A7n\u666E\u901A\u653B\u51FB" + "\n"
						...
						+ "\u00A76\u00A7n\u53F3\u952E\u653B\u51FB" + "\n"
						+ ("\u00A7e\u6D88\u8017\u9971\u98DF\u5EA6\u5BF9\u9644\u8FD1\u4EC7\u6068\u4F60\u7684\u751F\u7269\u9020\u6210\u00A7b" + new java.text.DecimalFormat("##.##%").format(0.3 * HSjinglianProcedure.execute(entity, itemstack))
								+ "\u00A7e\u653B\u51FB\u529B\u7684\u95EA\u7535\u4F24\u5BB3\uFF0C\u51B7\u53742\u79D2")
						+ "\n" + "\u00A76\u00A7n\u6F5C\u884C+\u53F3\u952E" + "\n" + ("\u00A7e\u6D88\u801720%\u6700\u5927\u751F\u547D\u503C\u83B7\u5F97\u00A7b"
								+ new java.text.DecimalFormat("").format(1 + HSjinglianupProcedure.execute(entity, itemstack)) + "\u00A7e\u7EA7\u6301\u7EED0.25\u79D2\u9971\u548C\u6548\u679C"));
	}
}