	...
	public static void execute(LevelAccessor world, Entity entity, ItemStack itemstack) {
		...
		if (!world.isClientSide()) {
			...
			if (itemstack.getOrDefault(DataComponents.CUSTOM_DATA, CustomData.EMPTY).copyTag().getBoolean("feng")) {
				...
				if (!(entity instanceof LivingEntity _livEnt20 && _livEnt20.hasEffect(PrimogemcraftModMobEffects.FEIXING))) {
					if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
			...
			if (itemstack.getOrDefault(DataComponents.CUSTOM_DATA, CustomData.EMPTY).copyTag().getBoolean("lei")) {
				...
				if (entity instanceof LivingEntity _livEnt25 && _livEnt25.hasEffect(PrimogemcraftModMobEffects.GOUYU)) {
					if (d >= 2) {
						if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
			...
			if (itemstack.getOrDefault(DataComponents.CUSTOM_DATA, CustomData.EMPTY).copyTag().getBoolean("cao")) {
				...
				if (!(entity instanceof LivingEntity _livEnt35 && _livEnt35.hasEffect(MobEffects.HEALTH_BOOST)) && !(entity instanceof LivingEntity _livEnt36 && _livEnt36.hasEffect(PrimogemcraftModMobEffects.SZTSXCWDP))) {
			...
			if (itemstack.getOrDefault(DataComponents.CUSTOM_DATA, CustomData.EMPTY).copyTag().getBoolean("shui")) {
				...
				if (e >= 2) {
					if (!(entity instanceof LivingEntity _livEnt51 && _livEnt51.hasEffect(MobEffects.CONDUIT_POWER))) {
						if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
							_entity.addEffect(new MobEffectInstance(MobEffects.CONDUIT_POWER, 80, 0, true, false));
					}
				}
				if (!(entity instanceof LivingEntity _livEnt53 && _livEnt53.hasEffect(PrimogemcraftModMobEffects.DJQJKJXGXIANZHI)) && entity.isAlive()) {
					if (e >= 4) {
						if (e < 6) {
							a1 = e * 20;
							if (entity instanceof LivingEntity _entity)
			...
			if (itemstack.getOrDefault(DataComponents.CUSTOM_DATA, CustomData.EMPTY).copyTag().getBoolean("huo")) {
				...
				if (!(entity instanceof LivingEntity _livEnt66 && _livEnt66.hasEffect(MobEffects.FIRE_RESISTANCE))) {
					if (f >= 2) {
						if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
