...
import net.per.enchant.hunt.HuntEffect;
...
public class Fengraoshuxing3Procedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
		...
		if (!world.isClientSide()) {
			if (entity instanceof LivingEntity _livEnt1 && _livEnt1.hasEffect(PrimogemcraftModMobEffects.FENGRAO)) {
				se = sourceentity;
				if (HuntEffect.Effect(world, entity, sourceentity))
					return;
